	...
	*/
	...
	function createPKCS10Internal(config={})
	{
	    ...
	    pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
	        ...
	        value: new Utf8String({ value: config.commonName })
	    }));

		if(config.organization) {
	        pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
	            type: "2.5.6.4",//organization
	            value: new PrintableString({value: config.organization})
	        }));
	    }
		if(config.organizationalUnit) {
	        pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
	            type: "2.5.6.5",//organizationalUnit
	            value: new PrintableString({value: config.organizationalUnit})
	        }));
	    }
	    if(config.organizationName) {
	        pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
	            type: "2.5.4.10",//organization
	            value: new PrintableString({value: config.organizationName})
	        }));
	    }
	    if(config.organizationalUnitName) {
	        pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
	            type: "2.5.4.11",//organizationalUnit
	            value: new PrintableString({value: config.organizationalUnitName})
	        }));
	    }
	    ...
	    if(config.countryName) {
	        pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
	            ...
	            value: new PrintableString({value: config.countryName})
	        }));
	    }
	    ...
	    if(config.stateOrProvinceName) {
	        pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
	            ...
	            value: new PrintableString({value: config.stateOrProvinceName})
	        }));
	    }
	    if(config.localityName) {
	        pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
	            type: "2.5.4.7",//stateOrProvinceName
	            value: new PrintableString({value: config.localityName})
	        }));
	    }
	    if(config.streetAddress) {
	        pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
	            type: "2.5.4.9",//streetAddress
	            value: new PrintableString({value: config.streetAddress})
	        }));
	    }
	    ...
	    if(config.iPAddress) {
	        gn.names.push( new GeneralName({
	            type: 7, // iPAddress
	            value: new OctetString({valueHex: (new Uint8Array(config.iPAddress.split("."))).buffer})
	        }));
	    }
